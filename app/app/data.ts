...
export const skills = [
  { group: "Research", items: ["Qualitative methods", "Data storytelling", "Policy analysis"] },
  { group: "Technical", items: ["Python", "TypeScript", "SQL", "Figma"] },
  { group: "Languages", items: ["Vietnamese / native", "English / fluent", "French / conversational"] },
];
