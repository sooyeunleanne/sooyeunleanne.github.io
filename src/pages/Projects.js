...
import projects_linedeco from '../images/projects_linedeco.svg';
...
const Projects = () => {
  ...
  const onButtonContainerClick = useCallback(() => {
    window.open("https://github.com/JaryJay/love-thy-hood.git");
  }, []);

  const onButtonContainer1Click = useCallback(() => {
    window.open("https://youtu.be/rGr_D0UZhUU");
  }, []);

  const onButtonContainer2Click = useCallback(() => {
    window.open("https://github.com/acrenw/JAMHacks7");
  }, []);
  ...
  const onButtonContainer3Click = useCallback(() => {
    window.open("https://github.com/acrenw/my-app");
  }, []);
    ...
    <div className={styles.projects}>
      ...
      <div className={styles.lovethyhood}>
        ...
        <div className={styles.button} onClick={onButtonContainerClick}>
          ...
          <b className={styles.openRepository}>Open Repository</b>
        </div>
      </div>
      <div className={styles.foodieco1}>
        ...
        <div className={styles.button1} onClick={onButtonContainer1Click}>
          <div className={styles.buttonChild} />
          <b className={styles.openRepository}>Demo Video</b>
        </div>
      </div>
